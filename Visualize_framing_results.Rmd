...
top_topics %>%
  ungroup() %>%
  select(year,rank,topic,distance,Dem_terms,Rep_terms) %>%
  rename("Year"=year,'Topic Rank'=rank,"Topic"=topic,'Cosine Distance'=distance,"Most Democratic Terms"=Dem_terms,'Most Republican Terms'=Rep_terms) %>%
  gt() %>%
  tab_header(
