...
df <- read.csv('Results/True_Frame.csv')
...
top_topics %>%
  ...
  rename("Year"=year,'Topic Rank'=rank,"Topic"=topic,"Most Democratic Terms"=Dem_terms,'Most Republican Terms'=Rep_terms,'Avg Democrat corr.'=Dem_strength,'Avg Republican corr.'=Rep_strength) %>%
  gt() %>%
  tab_header(
  ...
  fmt_number(
    columns='Avg Democrat corr.',
    decimals = 2
  ) %>% 
  fmt_number(
    columns='Avg Republican corr.',
    decimals = 2
  ) %>% 
  tab_style(
    style = list(
